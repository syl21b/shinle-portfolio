...
import RetailAnalysis from '/src/components/image/retail-analysis.png';
export const projects = [
  ...
  description: "Production-grade business intelligence dashboard with AI natural language querying, what‑if simulation, RFM segmentation, cohort retention analysis, and cross‑filtering visualizations.",
  problem: "Traditional BI tools require technical SQL knowledge to extract insights, lack interactive cross‑filtering between charts, and offer no predictive simulation capabilities. Business users struggle to ask ad‑hoc questions, identify revenue anomalies, or forecast the impact of operational changes without heavy engineering support.",
  solution: "Built a full‑stack BI platform that processes 4M+ records with 99.8% data validity. Features include: natural language querying (NLQ) that converts plain English into SQL, click‑based cross‑filtering across all charts, revenue anomaly detection, RFM/LTV segmentation, cohort retention heatmaps, and a what‑if simulator that estimates revenue uplift from changes in repeat rate, AOV, churn, or fulfillment days. All powered by a Flask backend, PostgreSQL data warehouse, and a responsive Plotly‑based frontend.",
  contributions: [
    ...
    "<strong>Revenue Anomaly Detection:</strong> Automated detection of daily revenue drops >20% with visual markers on trends and Slack/Jira alerts.",
  ...
  technologies: [
    ...
    "JWT Authentication", "Rate Limiting", "Cache Management"
  ],
  challenges: [
  ...
  buttonVariant: "btn-primary",
  buttonVariant2: "btn-outline",
  imagePreview: RetailAnalysis, // Add a preview image path if available
  keyMetrics: [
