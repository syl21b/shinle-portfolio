...
export default function ResumePageBISpecialist() {
  ...
  const downloadPDF = async () => {
    ...
    try {
      ...
      pdf.setFontSize(10);
      pdf.setTextColor(30, 90, 142);
      pdf.textWithLink('Sales Performance Optimization Dashboard', margin, yPos, { url: 'https://public.tableau.com/views/Superstore_17455418407990/ExecutiveSummaryDashboard?:language=en-US&:sid=&:redirect=auth&:display_count=n&:origin=viz_share_link' });
      pdf.setTextColor(0, 0, 0);
      pdf.setFont('helvetica', 'normal');
      ...
      pdf.setFontSize(10);
      pdf.setTextColor(30, 90, 142);
      pdf.textWithLink('Financial Services Risk Assessment Platform', margin, yPos, { url: 'https://public.tableau.com/views/StockMarket_17475986132330/Menu' });
      pdf.setTextColor(0, 0, 0);
      pdf.setFont('helvetica', 'normal');
